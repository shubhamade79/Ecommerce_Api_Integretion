...
@app.get("/users/{user_id}/address", response_model=list[schemas.AddressResponse])
...
@app.get("/users/{user_id}/card", response_model=list[schemas.CardResponse])
def get_card(user_id: int, db: Session = Depends(get_db)):
    return crud.get_card_for_user(db=db, user_id=user_id)

@app.delete("/users/{user_id}/card/{product_id}", response_model=schemas.CardResponse)
...
@app.patch("/card/{cart_id}", response_model=schemas.CardResponse)
...
@app.post("/review", response_model=list[schemas.ReviewResponse])
...
@app.get("/review/{product_id}",response_model=list[schemas.ReviewResponse])
...
@app.put("/review/{review_id}", response_model=schemas.ReviewResponse)
...
@app.post("/user/{user_id}/order", response_model=list[schemas.OrderResponse])
...
@app.get("/user/{user_id}/order", response_model=list[schemas.OrderResponse])
